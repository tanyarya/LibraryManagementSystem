...
<body style="background-image: url('https://www.teahub.io/photos/full/204-2044048_library-background-hd.jpg');">
...
<h3 style="color:white; margin-left:860px; margin-top:100px;text-decoration:underline; font-weight:bold;">ISSUED BOOKS</h3>
<table border="0" class="table" cellpadding="10" cellspacing="10">
  <tbody>
    <tr class="labels" style="text-decoration:underline;"><th>Book Name</th><th>Author</th><th>Issued by</th><th>Date</th><th>Return</th></tr>
    <?php
...
<td><?php echo $y['date'];?></td><td><a href="return.php?r=<?php echo $y['id'];?>" class="link" style="color:white">RETURN</a></td>
</tr>
<?php
}
?>
