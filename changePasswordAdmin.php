...
<head>
    ...
    <link rel="stylesheet" href="changePasswordAdmin.css" />
    <title>index</title>
...
<nav class="navbar navbar-expand-lg ">
  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
    ...
    <br>
    <P><a class ="atag" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
