...
<nav class="navbar navbar-expand-lg ">
  ...
  <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-9 8c0 1 1 1 1 1h5v-1a1.9 1.9 0 0 1 .01-.2 4.49 4.49 0 0 1 1.534-3.693C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4Zm7 0a1 1 0 0 1 1-1v-1a2 2 0 1 1 4 0v1a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-2Zm3-3a1 1 0 0 0-1 1v1h2v-1a1 1 0 0 0-1-1Z"/>
 	...
 	<div class="login">
        	<span class="form" style="margin-left:500px" >
            <h2>Add Book</h2>
            <button class="button"><a href="addBooks.php">CLICK HERE</a></button> 
			</span>
        <span class="form" style="margin-left:100px">
            <h2>See Book Request</h2>
            <button class="button"><a href="bookRequests.php">CLICK HERE</a></button>
		</span>
	</div>
		<span class="form" style="margin-left:790px">
            <h2>Issued Books</h2>
              <button class="button"><a href="issue.php">CLICK HERE</a></button>
		</span>
</body>
</html>